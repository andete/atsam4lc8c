...
#[doc = "Possible values of the field `ECCERR`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ECCERRR {
    #[doc = "no error"]
    NOERROR,
    #[doc = "one ECC error detected"]
    ONEECCERR,
