...
impl W {
    ...
    #[doc = "Bits 0:11 - Fractional part of Threshold Value"]
    #[inline]
    pub fn fthresh(&mut self) -> _FTHRESHW {
        _FTHRESHW { w: self }
    }
    #[doc = "Bits 12:19 - Rational part of Threshold Value"]
    #[inline]
    pub fn rthresh(&mut self) -> _RTHRESHW {
        _RTHRESHW { w: self }
    }
    #[doc = "Bit 23 - Threshold Direction"]
    #[inline]
