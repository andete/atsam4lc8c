...
impl R {
    ...
    #[inline]
    pub fn esamples(&self) -> ESAMPLESR {
        let bits = {
            const MASK: u8 = 127;
            const OFFSET: u8 = 8;
...
impl W {
    ...
    #[doc = "Bit 4 - Internal Resistors"]
    #[inline]
    pub fn intres(&mut self) -> _INTRESW {
        _INTRESW { w: self }
    }
    #[doc = "Bit 5 - Clock Select"]
    #[inline]
    ...
    #[doc = "Bits 8:14 - Number of Event Samples"]
    #[inline]
    pub fn esamples(&mut self) -> _ESAMPLESW {
        _ESAMPLESW { w: self }
    }
    #[doc = "Bits 16:19 - Charge Time"]
    #[inline]
    pub fn charget(&mut self) -> _CHARGETW {
        _CHARGETW { w: self }
    }
    #[doc = "Bit 31 - Software Reset"]
    #[inline]
