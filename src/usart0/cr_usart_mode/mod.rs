...
impl<'a> _RTSENW<'a> {
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(RTSENW::_0)
    }
    #[doc = "Drives the pin RTS to 0"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(RTSENW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `RTSDIS`"]
pub enum RTSDISW {
    #[doc = "No effect"]
    _0,
...
impl<'a> _RTSDISW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: RTSDISW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(RTSDISW::_0)
    }
    #[doc = "Drives the pin RTS to 1"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(RTSDISW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
