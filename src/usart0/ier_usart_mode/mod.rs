...
#[doc = "Values that can be written to the field `MANEA`"]
pub enum MANEAW {
    #[doc = "No effect"]
    _0,
    #[doc = "Enables the interrupt"]
...
#[doc = r" Proxy"]
pub struct _MANEAW<'a> {
    w: &'a mut W,
}
impl<'a> _MANEAW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: MANEAW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(MANEAW::_0)
    }
    #[doc = "Enables the interrupt"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(MANEAW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
