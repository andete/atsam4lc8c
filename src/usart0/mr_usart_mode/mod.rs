...
#[doc = "Possible values of the field `VAR_SYNC`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum VAR_SYNCR {
...
impl VAR_SYNCR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> VAR_SYNCR {
        match value {
            false => VAR_SYNCR::_0,
            true => VAR_SYNCR::_1,
        }
...
#[doc = "Possible values of the field `MAN`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MANR {
...
#[doc = "Possible values of the field `MODSYNC`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MODSYNCR {
...
impl MODSYNCR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> MODSYNCR {
        match value {
            false => MODSYNCR::_0,
            true => MODSYNCR::_1,
        }
...
impl<'a> _MSBFW<'a> {
    ...
    pub fn lsbf(self) -> &'a mut W {
        self.variant(MSBFW::LSBF)
    }
    #[doc = "Most Significant Bit first"]
    #[inline]
    pub fn msbf(self) -> &'a mut W {
        self.variant(MSBFW::MSBF)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `VAR_SYNC`"]
pub enum VAR_SYNCW {
    #[doc = "User defined configuration of command or data sync field depending on SYNC value"]
    _0,
    #[doc = "The sync field is updated when a character is written into THR register"]
...
impl<'a> _VAR_SYNCW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: VAR_SYNCW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(VAR_SYNCW::_0)
    }
    #[doc = "The sync field is updated when a character is written into THR register"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(VAR_SYNCW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `MAN`"]
pub enum MANW {
    #[doc = "Manchester Encoder/Decoder is disabled"]
    _0,
    #[doc = "Manchester Encoder/Decoder is enabled"]
...
impl<'a> _MANW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: MANW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(MANW::_0)
    }
    #[doc = "Manchester Encoder/Decoder is enabled"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(MANW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `MODSYNC`"]
pub enum MODSYNCW {
    #[doc = "The Manchester Start bit is a 0 to 1 transition"]
    _0,
    #[doc = "The Manchester Start bit is a 1 to 0 transition"]
...
impl<'a> _MODSYNCW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: MODSYNCW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(MODSYNCW::_0)
    }
    #[doc = "The Manchester Start bit is a 1 to 0 transition"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(MODSYNCW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _ONEBITW<'a> {
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(ONEBITW::_0)
    }
    #[doc = "Start Frame delimiter is One Bit"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(ONEBITW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
