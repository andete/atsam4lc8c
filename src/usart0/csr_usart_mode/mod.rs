...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ITERR {
    #[doc = "Maximum number of repetitions has not been reached since the last RSIT"]
    _0,
    #[doc = "Maximum number of repetitions has been reached since the last RSIT"]
    _1,
}
impl ITERR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
...
#[doc = "Possible values of the field `MANERR`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MANERRR {
    #[doc = "No Manchester error has been detected since the last RSTSTA"]
    _0,
    #[doc = "At least one Manchester error has been detected since the last RSTSTA"]
    _1,
}
impl MANERRR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> MANERRR {
        match value {
            false => MANERRR::_0,
            true => MANERRR::_1,
        }
