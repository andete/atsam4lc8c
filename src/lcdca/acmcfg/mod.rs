...
impl W {
    ...
    #[doc = "Bit 4 - Digit Reverse"]
    #[inline]
    pub fn drev(&mut self) -> _DREVW {
        _DREVW { w: self }
    }
    #[doc = "Bits 5:6 - Type of Digit"]
    #[inline]
    pub fn tdg(&mut self) -> _TDGW {
        _TDGW { w: self }
    }
    #[doc = "Bits 8:13 - Start Segment"]
    #[inline]
    pub fn stseg(&mut self) -> _STSEGW {
        _STSEGW { w: self }
    }
    #[doc = "Bits 16:23 - Scrolling Steps"]
    #[inline]
    pub fn steps(&mut self) -> _STEPSW {
        _STEPSW { w: self }
    }
    #[doc = "Bits 24:27 - Digit Number"]
    #[inline]
    pub fn dign(&mut self) -> _DIGNW {
        _DIGNW { w: self }
    }
}
