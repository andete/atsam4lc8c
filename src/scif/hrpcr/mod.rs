...
impl W {
    ...
    #[doc = "Bits 8:31 - High Resolution Counter"]
    #[inline]
    pub fn hrcount(&mut self) -> _HRCOUNTW {
        _HRCOUNTW { w: self }
    }
}
