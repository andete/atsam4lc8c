...
impl W {
    ...
    #[doc = "Bit 2 - Power Scaling Change Request"]
    #[inline]
    pub fn pscreq(&mut self) -> _PSCREQW {
        _PSCREQW { w: self }
    }
    #[doc = "Bit 3 - Power Scaling Change Mode"]
    #[inline]
    pub fn pscm(&mut self) -> _PSCMW {
        _PSCMW { w: self }
    }
    #[doc = "Bit 8 - BACKUP Mode"]
    #[inline]
