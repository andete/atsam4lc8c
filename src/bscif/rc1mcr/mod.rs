...
impl W {
    ...
    #[doc = "Bits 8:12 - 1MHz RC Osc Calibration"]
    #[inline]
    pub fn clkcal(&mut self) -> _CLKCALW {
        _CLKCALW { w: self }
    }
}
