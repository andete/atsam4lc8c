...
impl W {
    ...
    #[doc = "Bit 0 - 32 KHz Oscillator Enable"]
    #[inline]
    pub fn osc32en(&mut self) -> _OSC32ENW {
        _OSC32ENW { w: self }
    }
    #[doc = "Bit 1 - Pins Select"]
    #[inline]
    ...
    #[doc = "Bits 12:15 - Current selection"]
    #[inline]
    pub fn selcurr(&mut self) -> _SELCURRW {
        _SELCURRW { w: self }
    }
    #[doc = "Bits 16:18 - Oscillator Start-up Time"]
    #[inline]
