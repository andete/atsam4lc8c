...
impl W {
    ...
    #[inline]
    pub fn nreplys(&mut self) -> _NREPLYSW {
        _NREPLYSW { w: self }
    }
    ...
    #[inline]
    pub fn busy0s(&mut self) -> _BUSY0SW {
        _BUSY0SW { w: self }
    }
    #[doc = "Bit 25 - BUSY1 Set"]
    #[inline]
    pub fn busy1s(&mut self) -> _BUSY1SW {
        _BUSY1SW { w: self }
    }
}
