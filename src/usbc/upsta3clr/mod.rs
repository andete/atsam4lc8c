...
#[doc = r" Proxy"]
pub struct _RAMACERICW<'a> {
    w: &'a mut W,
}
impl<'a> _RAMACERICW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn perric(&mut self) -> _PERRICW {
        _PERRICW { w: self }
    }
    ...
    #[inline]
    pub fn errorfic(&mut self) -> _ERRORFICW {
        _ERRORFICW { w: self }
    }
    ...
    #[inline]
    pub fn ramaceric(&mut self) -> _RAMACERICW {
        _RAMACERICW { w: self }
    }
}
