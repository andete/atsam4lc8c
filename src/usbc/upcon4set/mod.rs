...
#[doc = r" Proxy"]
pub struct _ERRORFIESW<'a> {
    w: &'a mut W,
}
impl<'a> _ERRORFIESW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _RAMACERESW<'a> {
    w: &'a mut W,
}
impl<'a> _RAMACERESW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _INITDTGLSW<'a> {
    w: &'a mut W,
}
impl<'a> _INITDTGLSW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn errorfies(&mut self) -> _ERRORFIESW {
        _ERRORFIESW { w: self }
    }
    ...
    #[inline]
    pub fn ramaceres(&mut self) -> _RAMACERESW {
        _RAMACERESW { w: self }
    }
    ...
    #[inline]
    pub fn initdtgls(&mut self) -> _INITDTGLSW {
        _INITDTGLSW { w: self }
    }
    #[doc = "Bit 19 - INITBK Set"]
    #[inline]
    pub fn initbks(&mut self) -> _INITBKSW {
        _INITBKSW { w: self }
    }
}
