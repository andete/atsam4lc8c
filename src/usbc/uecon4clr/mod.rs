...
#[doc = r" Proxy"]
pub struct _RAMACERECW<'a> {
    w: &'a mut W,
}
impl<'a> _RAMACERECW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn nreplyc(&mut self) -> _NREPLYCW {
        _NREPLYCW { w: self }
    }
    #[doc = "Bit 11 - RAMACERE Clear"]
    #[inline]
    pub fn ramacerec(&mut self) -> _RAMACERECW {
        _RAMACERECW { w: self }
    }
    ...
    #[inline]
    pub fn busy0c(&mut self) -> _BUSY0CW {
        _BUSY0CW { w: self }
    }
    #[doc = "Bit 25 - BUSY1 Clear"]
    #[inline]
    pub fn busy1c(&mut self) -> _BUSY1CW {
        _BUSY1CW { w: self }
    }
}
