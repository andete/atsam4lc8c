...
#[doc = r" Proxy"]
pub struct _ERRORFIECW<'a> {
    w: &'a mut W,
}
impl<'a> _ERRORFIECW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn errorfiec(&mut self) -> _ERRORFIECW {
        _ERRORFIECW { w: self }
    }
    ...
    #[inline]
    pub fn initbkc(&mut self) -> _INITBKCW {
        _INITBKCW { w: self }
    }
}
