...
impl W {
    ...
    #[inline]
    pub fn ep0intes(&mut self) -> _EP0INTESW {
        _EP0INTESW { w: self }
    }
    #[doc = "Bit 13 - EP1INT Interrupt Enable Set"]
    #[inline]
    pub fn ep1intes(&mut self) -> _EP1INTESW {
        _EP1INTESW { w: self }
    }
    #[doc = "Bit 14 - EP2INT Interrupt Enable Set"]
    #[inline]
    pub fn ep2intes(&mut self) -> _EP2INTESW {
        _EP2INTESW { w: self }
    }
    #[doc = "Bit 15 - EP3INT Interrupt Enable Set"]
    #[inline]
    pub fn ep3intes(&mut self) -> _EP3INTESW {
        _EP3INTESW { w: self }
    }
    #[doc = "Bit 16 - EP4INT Interrupt Enable Set"]
    #[inline]
    pub fn ep4intes(&mut self) -> _EP4INTESW {
        _EP4INTESW { w: self }
    }
    #[doc = "Bit 17 - EP5INT Interrupt Enable Set"]
    #[inline]
    pub fn ep5intes(&mut self) -> _EP5INTESW {
        _EP5INTESW { w: self }
    }
    #[doc = "Bit 18 - EP6INT Interrupt Enable Set"]
    #[inline]
    pub fn ep6intes(&mut self) -> _EP6INTESW {
        _EP6INTESW { w: self }
    }
    #[doc = "Bit 19 - EP7INT Interrupt Enable Set"]
    #[inline]
    pub fn ep7intes(&mut self) -> _EP7INTESW {
        _EP7INTESW { w: self }
    }
}
