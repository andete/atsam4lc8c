...
#[doc = r" Proxy"]
pub struct _REFBUFDISW<'a> {
    w: &'a mut W,
}
impl<'a> _REFBUFDISW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn refbufen(&mut self) -> _REFBUFENW {
        _REFBUFENW { w: self }
    }
    #[doc = "Bit 5 - Reference buffer disable"]
    #[inline]
    pub fn refbufdis(&mut self) -> _REFBUFDISW {
        _REFBUFDISW { w: self }
    }
    ...
    #[inline]
    pub fn bgreqen(&mut self) -> _BGREQENW {
        _BGREQENW { w: self }
    }
    #[doc = "Bit 11 - Bandgap buffer request disable"]
    #[inline]
    pub fn bgreqdis(&mut self) -> _BGREQDISW {
        _BGREQDISW { w: self }
    }
}
