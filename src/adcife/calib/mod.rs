...
impl W {
    ...
    #[doc = "Bit 8 - Select bias mode"]
    #[inline]
    pub fn biassel(&mut self) -> _BIASSELW {
        _BIASSELW { w: self }
    }
    #[doc = "Bits 12:15 - Bias Calibration"]
    #[inline]
    pub fn biascal(&mut self) -> _BIASCALW {
        _BIASCALW { w: self }
    }
    #[doc = "Bit 16 - Flash Calibration Done"]
    #[inline]
