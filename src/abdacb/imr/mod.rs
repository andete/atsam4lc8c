...
pub enum TXRDYR {
    #[doc = "The Audio DAC TX Ready interrupt is disabled"]
    _0,
    #[doc = "The Audio DAC TX Ready interrupt is enabled"]
    _1,
}
impl TXRDYR {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TXURR {
    #[doc = "The Audio DAC Underrun interrupt is disabled"]
    _0,
    #[doc = "The Audio DAC Underrun interrupt is enabled"]
    _1,
}
impl TXURR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
