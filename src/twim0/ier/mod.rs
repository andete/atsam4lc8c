...
impl W {
    ...
    #[inline]
    pub fn crdy(&mut self) -> _CRDYW {
        _CRDYW { w: self }
    }
    #[doc = "Bit 3 - Command Complete"]
    #[inline]
    pub fn ccomp(&mut self) -> _CCOMPW {
        _CCOMPW { w: self }
    }
    ...
    #[inline]
    pub fn busfree(&mut self) -> _BUSFREEW {
        _BUSFREEW { w: self }
    }
    #[doc = "Bit 8 - NAK in Address Phase Received"]
    #[inline]
    pub fn anak(&mut self) -> _ANAKW {
        _ANAKW { w: self }
    }
    #[doc = "Bit 9 - NAK in Data Phase Received"]
    #[inline]
    pub fn dnak(&mut self) -> _DNAKW {
        _DNAKW { w: self }
    }
    ...
    #[inline]
    pub fn hsmcack(&mut self) -> _HSMCACKW {
        _HSMCACKW { w: self }
    }
}
