...
impl W {
    ...
    #[doc = "Bit 12 - Transfer is to same address as previous address"]
    #[inline]
    pub fn repsame(&mut self) -> _REPSAMEW {
        _REPSAMEW { w: self }
    }
    #[doc = "Bit 13 - Send START condition"]
    #[inline]
    ...
    #[doc = "Bit 25 - ACK Last Master RX Byte"]
    #[inline]
    pub fn acklast(&mut self) -> _ACKLASTW {
        _ACKLASTW { w: self }
    }
    #[doc = "Bit 26 - HS-mode"]
    #[inline]
    ...
    #[doc = "Bits 28:30 - HS-mode Master Code"]
    #[inline]
    pub fn hsmcode(&mut self) -> _HSMCODEW {
        _HSMCODEW { w: self }
    }
}
