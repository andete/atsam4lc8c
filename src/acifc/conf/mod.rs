...
impl W {
    ...
    #[doc = "Bits 8:9 - Negative Input Select"]
    #[inline]
    pub fn inseln(&mut self) -> _INSELNW {
        _INSELNW { w: self }
    }
    #[doc = "Bit 16 - Peripheral Event Enable Negative"]
    #[inline]
    pub fn evenn(&mut self) -> _EVENNW {
        _EVENNW { w: self }
    }
    #[doc = "Bit 17 - Peripheral Event Enable Positive"]
    #[inline]
    pub fn evenp(&mut self) -> _EVENPW {
        _EVENPW { w: self }
    }
    #[doc = "Bits 24:25 - Hysteresis Voltage Value"]
    #[inline]
