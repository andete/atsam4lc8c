...
impl R {
    ...
    #[inline]
    pub fn twi_slave_0(&self) -> TWI_SLAVE_0R {
        let bits = {
    ...
    #[inline]
    pub fn twi_slave_1(&self) -> TWI_SLAVE_1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn bod18_irq(&self) -> BOD18_IRQR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn bod33_irq(&self) -> BOD33_IRQR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
